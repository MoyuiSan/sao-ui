...
// load the styles
var content = __webpack_require__("5816");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("0636f397", content, true, {"sourceMap":false,"shadowMode":false});
...
// module
exports.push([module.i, ".music-box[data-v-2e605d4c]{position:fixed;width:280px;-webkit-box-sizing:border-box;box-sizing:border-box;border:1px solid #000;z-index:900;top:0;left:5px}.music-box[data-v-2e605d4c],.music-box .music-img[data-v-2e605d4c]{display:-webkit-box;display:-ms-flexbox;display:flex;height:60px}.music-box .music-img[data-v-2e605d4c]{position:relative;width:60px;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.music-box .music-img img[data-v-2e605d4c]{width:50px;height:50px;cursor:pointer}.music-box .music-img .posImg[data-v-2e605d4c]{position:absolute;top:5px;height:5px;width:50px;height:50px}.music-box .music-img .posImg img[data-v-2e605d4c]{opacity:.5}.music-box .music-mes[data-v-2e605d4c]{width:220px;height:60px;position:relative;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.music-box .music-mes .music-mes-title[data-v-2e605d4c]{width:215px;height:25px;margin-top:5px;font-size:14px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:start;-ms-flex-pack:start;justify-content:flex-start;-webkit-box-sizing:border-box;box-sizing:border-box;border-bottom:1px solid #000;cursor:pointer}.music-box .music-mes .music-mes-title p[data-v-2e605d4c]{width:100%;text-align:left}.music-box .music-mes .music-mes-title p[data-v-2e605d4c]:hover{-webkit-animation:textgo-data-v-2e605d4c 5s linear infinite;animation:textgo-data-v-2e605d4c 5s linear infinite}.music-box .music-mes .contral[data-v-2e605d4c]{width:215px;height:25px;display:-webkit-box;display:-ms-flexbox;display:flex;position:relative}.music-box .music-mes .contral .ctl-1[data-v-2e605d4c]{position:relative;width:135px;height:100%;cursor:pointer}.music-box .music-mes .contral .ctl-2[data-v-2e605d4c]{position:relative;width:80px;height:100%;display:-webkit-box;display:-ms-flexbox;display:flex}.music-box .music-mes .contral .ctl-2 .prorgess[data-v-2e605d4c]{width:60px;height:100%;font-size:12px;line-height:32px}.music-box .music-mes .contral .ctl-2 .more[data-v-2e605d4c]{width:20px;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:end;-ms-flex-pack:end;justify-content:flex-end;-webkit-box-align:end;-ms-flex-align:end;align-items:flex-end}.music-box .music-mes .contral .ctl-2 .more img[data-v-2e605d4c]{width:20px;height:20px;cursor:pointer}.music-box .music-mes .contral span[data-v-2e605d4c]{position:absolute;font-size:12px;top:0;left:0;-webkit-transition:left .1s linear;transition:left .1s linear}.music-box .music-ctl[data-v-2e605d4c]{position:absolute;width:280px;height:40px;-webkit-box-sizing:border-box;box-sizing:border-box;border-bottom:1px solid #000;top:60px;left:-1px;background-color:#fff;-webkit-animation:showCtl-data-v-2e605d4c .8s ease;animation:showCtl-data-v-2e605d4c .8s ease;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards}.music-box .music-ctl[data-v-2e605d4c],.music-box .music-ctl .music-ctl-item[data-v-2e605d4c]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-transition:background-color .4s;transition:background-color .4s}.music-box .music-ctl .music-ctl-item[data-v-2e605d4c]{width:25%;height:100%;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;cursor:pointer}.music-box .music-ctl .music-ctl-item[data-v-2e605d4c]:hover{background-color:#ececec}.music-box .music-ctl .music-ctl-item img[data-v-2e605d4c]{width:20px;height:20px}.music-box .music-ctl[data-v-2e605d4c]:after{right:0}.music-box .music-ctl[data-v-2e605d4c]:after,.music-box .music-ctl[data-v-2e605d4c]:before{content:\"\";position:absolute;height:20px;width:1px;top:20px;background-color:#000}.music-box .music-ctl[data-v-2e605d4c]:before{left:0}@-webkit-keyframes textgo-data-v-2e605d4c{0%{margin-left:0}to{margin-left:-150px}}@keyframes textgo-data-v-2e605d4c{0%{margin-left:0}to{margin-left:-150px}}@-webkit-keyframes showCtl-data-v-2e605d4c{0%{opacity:0}to{opacity:1}}@keyframes showCtl-data-v-2e605d4c{0%{opacity:0}to{opacity:1}}@-webkit-keyframes noCtl-data-v-2e605d4c{0%{opacity:1}to{opacity:0}}@keyframes noCtl-data-v-2e605d4c{0%{opacity:1}to{opacity:0}}", ""]);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_10_oneOf_1_0_node_modules_css_loader_index_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_3_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_music_box_vue_vue_type_style_index_0_id_2e605d4c_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("1e37");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_10_oneOf_1_0_node_modules_css_loader_index_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_3_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_music_box_vue_vue_type_style_index_0_id_2e605d4c_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_10_oneOf_1_0_node_modules_css_loader_index_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_3_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_music_box_vue_vue_type_style_index_0_id_2e605d4c_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_10_oneOf_1_0_node_modules_css_loader_index_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_10_oneOf_1_3_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_music_box_vue_vue_type_style_index_0_id_2e605d4c_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// EXTERNAL MODULE: ./packages/music/src/music-box.vue?vue&type=style&index=0&id=2e605d4c&lang=less&scoped=true&
var music_boxvue_type_style_index_0_id_2e605d4c_lang_less_scoped_true_ = __webpack_require__("f0e1");
...
var music_box_component = normalizeComponent(
  ...
  music_boxvue_type_template_id_2e605d4c_scoped_true_render,
  music_boxvue_type_template_id_2e605d4c_scoped_true_staticRenderFns,
  false,
  null,
  "2e605d4c",
  null
